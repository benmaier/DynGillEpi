...
N_nodes = 10
n_slices = 10
contact_list = [ [tuple(e) for e in nx.fast_gnp_random_graph(N_nodes,1./(N_nodes-1.)).edges()] for i in range(n_slices) ]
...
all_I = np.array(result.I)
all_SI = np.array(result.SI)
